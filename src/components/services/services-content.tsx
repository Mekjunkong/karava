      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          {categories.map((category) => {
            ...
            return (
              <FadeIn key={category}>
                <h2 className="text-xl font-semibold text-primary mb-5 flex items-center gap-3">
                  <div className="w-1 h-7 bg-gradient-to-b from-secondary to-secondary-dark rounded-full" />
                  <span className="font-serif tracking-wide">{t(`categories.${category}`)}</span>
                </h2>
